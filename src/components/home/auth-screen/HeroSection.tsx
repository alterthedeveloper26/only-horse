...
import HorseImage from "@public/horse-1.png";
    ...
    <div className="flex h-screen w-full">
      <div className="flex-1 flex overflow-hidden bg-[#00b0f0a6] relative justify-center items-center z-10 bg-noise">
        <img
          src="/of-logo.svg"
          alt="Only Horse logo"
          className="absolute opacity-15 -bottom-52 lg:scale-150 xl:scale-105 scale-[2] -left-1/4 pointer-events-none select-none"
        />
