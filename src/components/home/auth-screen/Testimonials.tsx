...
export function Testimonials() {
  return (
    <div className="mt-12">
      ...
      <p className="mt-4 mb-10 text-sm md:text-lg text-muted-foreground text-center">
        Hear from our happy customers and see why they love our service.
      </p>

      <div className="relative flex w-full flex-col items-center justify-center overflow-hidden border py-6 rounded-xl">
